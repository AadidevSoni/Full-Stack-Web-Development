...
// ----------------- Define
// In this example, we create a Counter constructor function, and inside it, we define a private variable count using the let keyword. 
// The increment, decrement, and getCount functions are defined as public methods, accessible from outside the object.

// Since the private variable count is defined inside the Counter constructor function, it forms a closure. The public methods 
// have access to this private variable due to the lexical scope of JavaScript closures.
